...
<html lang="en">
  <head>
    ...
    <title>project_apa</title>
  </head>

  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand" href="#">DanyIhza</a>
...
<div class="container">
    ...
    <div class="row workingspace">
        ...
        <div class="col-lg-5">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga soluta consequuntur laboriosam modi.</p>
    ...
    <section class="testimonial">
        <div class="row justify-content-center">
            <div class="col-8">
                <h5>"Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui culpa, deleniti sapiente necessitatibus nulla optio"</h5>
            </div>
        </div>
    </section>
    <!-- Akhir Testi -->
